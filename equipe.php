...
<body>
  ...
  <?php include 'nav.php'; ?>
     ...
     <main>
        ...
        <ul>
         <li>
         Caio Nayhan Olympio De Oliveira <br>
         <strong>Matrícula:</strong> 202503594449
         </li>
           <li>
               Marco Aurélio de Cruz Filho <br>
             <strong>Matrícula:</strong> 202502361173
             </li>
         <li>
           Leonardo Henrique Carvalho Avila <br>
         <strong>Matrícula:</strong> 202503254419
         </li>
         <li>
            Thiago de Jesus Silva Lemos <br>
         <strong>Matrícula:</strong> 202502948921
         </li>
        </ul>
